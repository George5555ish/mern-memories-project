...
import defaultImage from '../../../images/blog-img-01.jpg';
...
const Post = ({post, setCurrentId}) => {
    ...
    return(
      <Card className={classes.card}>
        ...
        <CardMedia className={classes.media} image={post.selectedFile === "" ? defaultImage: post.selectedFile} title={post.title}/>
